...
public class DeleteDishPop extends javax.swing.JFrame {
	...
	private void initComponents(Object x) {
		...
		jLabelText.setText("Do you want to remove the dish " + input + "?");
	...
	private void jButtonYesActionPerformed(java.awt.event.ActionEvent evt)
			throws SQLException {// GEN-FIRST:event_jButton_Inventory_OkActionPerformed
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(DeleteDishPop.class.getName())
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				new DeleteDishPop(null).setVisible(true);
			}
		});
	}
