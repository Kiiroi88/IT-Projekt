...
public class Searcher {
	...
	// Searches through the input list from database, compares and returns a
	// list of matched words with the
	// searched word.
	public ArrayList<String> searchThrough(ArrayList<String> list,
			String searchWord) {
